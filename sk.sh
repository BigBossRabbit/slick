...
if [ -n "$PROFILE_ID" ]; then
    # Main text color will rotate through national colors during prompts
    ...
    dconf write /org/gnome/terminal/legacy/profiles:/:${PROFILE_ID}/palette "['rgb(0,0,0)', 'rgb(210,16,52)', 'rgb(0,134,0)', 'rgb(220,163,0)', 'rgb(0,51,160)', 'rgb(210,16,52)', 'rgb(0,154,68)', 'rgb(255,255,255)', 'rgb(128,128,128)', 'rgb(255,105,97)', 'rgb(135,255,135)', 'rgb(255,255,135)', 'rgb(135,206,255)', 'rgb(255,135,255)', 'rgb(135,255,255)', 'rgb(255,255,255)']"
    dconf write /org/gnome/terminal/legacy/profiles:/:${PROFILE_ID}/use-theme-colors false
    echo -e "${G}Terminal colors configured with Namibian flag colors.${NC}"
fi

#------------------------------------------------------
# Package Management (Simplified for Tails)
